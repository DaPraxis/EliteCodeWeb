  ...
  },
  {
    ...
    contents: (
      <div>
        ...
        怎么和HR谈薪资、如何无痕跳到其他的组、咨询猎头信息等等。我们会持续为学生们提供帮助，为他们牵线搭桥更多业内资源和学习新的知识。</p>
        <p>我们的很多学生在毕业后甚至会申请加入我们的团队，成为导师或者咨询人脉，以过来人的身份帮助其他学生，从而形成<b>正向的资源循环。</b></p>
        <p>所以，加入我们，不仅是参加辅导课和bootcamp，更是加入一个<b>圈子</b>， <b>our program NEVER ends</b></p>
      </div>
    ),
  },
  {
    id: 6,
    title: `06. 和其他培训机构的区别是什么？为什么我要选择你？`,
    contents: (
      <div>
        <p>1. 我们不是学校/求职中介，我们不卖职位、不卖前程、不卖焦虑。我们的终极目标不只是为了让您求职上岸，更是让您在<b>找到心仪的职位同时兼备高超的职场能力</b>。
        其他的中介只会帮助您一年两年的求职期，而我们稳扎稳打，我们教授的知识可以使您终身受益。
        </p>
        <p>
          2. 我们提供更合理的收费模式。小班课的价格，科学定制化的辅导计划，涵盖各类知识体系，整体流程明码标价没有隐形收费、绑架消费。
        </p>
        <p>
          3. 难以比拟的行业和教学资源。辅导内容全面覆盖 New Grad 至 Senior 岗位面试所需知识，从代码入门至数据分析，人工智能，课程应有尽有。
        </p>
        <p></p>
      </div>
    ),
